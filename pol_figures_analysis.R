...
tr_export_centroids_proj_full_csv <- read_csv( "C:/Users/danka/Box/classes/plants and public health fall 2025/class project analysis/NYC_pollen_prod_estimates_251115.csv")
...
density_focal_sum <- rast("C:/Users/danka/Box/classes/plants and public health fall 2025/class project analysis/nyc_pop_density_1km_focal_sum.tif")
...
# map of tree pollen for a genus
    prod_1km_focal_sum <- rast(paste0("C:/Users/danka/Box/classes/plants and public health fall 2025/class project analysis/",
...
### visualizing a map of pollen exposure (pollen within 1 km x population density) #######################################
 ...
 focal_genus_list <- c("Acer", "Betula", "Gleditsia", "Morus", "Platanus", "Quercus", "Ulmus")
 for(i in 1:length(focal_genus_list)){
   focal_genus <-  focal_genus_list[i] #focal_genus <- "Quercus" #Morus Acer Gleditsia Platanus
